...
//
// 	activeTab = tab.Background(highlight)
//
// 	tabGap = tab.
// 		BorderTop(false).
// 		BorderLeft(false).
...
// 		fishCake := fishCakeStyle.Render("home")
...
// 		w := lipgloss.Width
//
// 		statusKey := statusStyle.Render("BCKSLASH")
// 		fishCake := fishCakeStyle.Render("Press ? for keybindings")
// 		statusVal := statusText.
// 			Width(width - w(statusKey) - w(fishCake)).
// 			Render("Ravishing")
//
